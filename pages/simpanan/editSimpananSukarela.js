      ...
      <main className="font-inter">
        <div className="w-auto min-h-screen mx-8 mt-10 mb-10">
          ...
          <div className="flex flex-wrap md:flex-nowrap">
            ...
            {/* flex kanan */}
            <div className="w-full container min-h-screen flex rounded-lg py-8 px-12 justify-center items-center bg-[#F0FFF4]">
              <img
...
export default editSimpananSukarela;
