        ...
        <main className="body-font">
          ...
          <div className="flex flex-row justify-between w-full">
            <div className="flex flex-row text-green-400 mx-8 mt-14">
              ...
              <p className="text-md font-bold mx-1">
          ...
          <div className="flex flex-row">
            ...
            <div className="mx-40 pl-96 mt-5 font-bold text-3xl mb-4">
              Pengingat
            </div>
          </div>
          <div className="flex flex-row">
            ...
            <div className="basis-10">
              <div className="text-gray-500">
                <div className="w-96 h-96 rounded-xl bg-green-300 bg-opacity-50 ">
                  <div className="pt-2 ml-5 text-xs">
                  ...
                  <div className="w-11/12 h-36 flex flex-row py-5 bg-[#EDF2F7] rounded-xl mx-auto mt-3 font-semibold drop-shadow-lg">
                    <div className="flex-col">
                      <div className="text-gray-600 pt-5 pl-5">
                        Tenggat Waktu
                      </div>
                      <div className="text-[#FF3A29] text-2xl pt-3 pl-8">
                        02 SEP
                      </div>
                    </div>
                    <div className="flex-col border-l-4 ml-5 text-gray-600 border-gray-600">
                      ...
                      <div className="flex pl-3">
                        <Link href="/">
                          <div className="ml-2 text-md font-medium cursor-pointer">
                            Lihat Selengkapnya
                          </div>
                        </Link>
                        <svg
