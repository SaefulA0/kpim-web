...
export default function tambahSimpananWajib() {
                    ...
                    <div className="my-2">
                      <label className="block">
                        ...
                        <input
                          ...
                          className="mt-1 text-gray-500 px-3 py-2 border shadow-sm border-slate-300 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md sm:text-sm focus:ring-1"
                        />
                      </label>
                    </div>
                    {/* field durasi */}
